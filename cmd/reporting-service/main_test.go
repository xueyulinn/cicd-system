...
func newDeps(h *fakeHandler, srv *fakeServer) dependencies {
	return dependencies{
		...
		newHandler:     func() (handler, error) { return h, nil },
		...
		getEnvOrDefault:       func(string, string) string { return "8083" },
...
func TestRunNewHandlerError(t *testing.T) {
	h := &fakeHandler{}
	srv := &fakeServer{}
	deps := newDeps(h, srv)
	deps.newHandler = func() (handler, error) {
		return nil, errors.New("new handler")
	}
