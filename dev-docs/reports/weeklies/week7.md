...
|----------------------------------------------------------------------------------------------------------------------------------------------------|--------|-----------| 
| [Create the base Helm chart and convert all stateless services into Helm templates.](https://github.com/CS7580-SEA-SP26/e-team/issues/214)         | M      | Asurkatha |
| [Add Helm support for the report database and schema migrations.](https://github.com/CS7580-SEA-SP26/e-team/issues/215)                            | S      | Asurkatha |
| [Document how to deploy and use the Kubernetes/Helm setup.](https://github.com/CS7580-SEA-SP26/e-team/issues/216)                                  | S      | Asurkatha |
| [Update the run request path so repository metadata can be sent from CLI to worker.](https://github.com/CS7580-SEA-SP26/e-team/issues/217)        | M     | Asurkatha |
| [Fix Kubernetes execution by removing dependence on mounting the CLI machine’s workspace path into the worker’s Docker daemon.](https://github.com/CS7580-SEA-SP26/e-team/issues/218) | M | Asurkatha | 
| [Deploy Postgres as StatefulSet with PVC (cluster-internal)](https://github.com/CS7580-SEA-SP26/e-team/issues/203) | M |Eugenia-Z|
...
2. Collectively decided the code refactoring required for migrating to k8s stack.  
